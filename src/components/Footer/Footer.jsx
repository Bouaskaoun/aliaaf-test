    ...
    <>
            ...
            <div className="col-lg-12">
              ...
              <div className="footer-col second">
                ...
                <ul className="list-unstyled li-space-lg p-small">
                  <li>
                    <a href="https://aliaaf.com/">Aliaaf</a>
                  </li>
                  <li>
                    <a href="https://fst-usmba.ac.ma/">FST FES</a>
                  </li>
                </ul>
              </div>
              <div className="footer-col third">
                ...
                <p className="p-small">
                  <a href="mailto:Aliaaf.contact@gmail.com">
                    <strong>Aliaaf.contact@gmail.com</strong>
                  </a>
                </p>
              </div>
            </div>
      ...
      <div className="copyright">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <p className="p-small">Copyright © {year} Aliaaf</p>
            </div>
          </div>
        </div>
      </div>
